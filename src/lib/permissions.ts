...
export const NAV_PERMISSIONS: Record<string, Role[]> = {
  ...
  "/internships": ["admin", "teacher", "student"],
  "/scholarships": ["admin", "teacher", "student"],
  "/accreditation": ["admin", "teacher"],
  "/ai-quiz": ["admin", "teacher", "student"],
  "/credentials": ["admin", "teacher", "student"],
  "/broadcast": ["admin", "teacher"],
  "/grievance-cell": ["admin", "teacher", "student"],
  "/hostel": ["admin", "teacher", "student"],
  "/alumni": ["admin", "teacher", "student"],
  ...
  "/transport": ["admin", "teacher", "student"],
  "/events-clubs": ["admin", "teacher", "student"],
  "/smart-attendance": ["admin", "teacher", "student"],
