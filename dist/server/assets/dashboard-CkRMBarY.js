import { x as commonjsGlobal, y as getDefaultExportFromCjs, c as reactExports, o as React, i as invariant, p as jsxRuntimeExports } from "./worker-entry-DxW2Qu7l.js";
import { u as useAuth, a as useNavigate } from "./router-Dohyv0--.js";
import { D as DashboardLayout, U as Users, C as ClipboardCheck, I as IndianRupee, c as UserCog, F as FileText } from "./DashboardLayout-CFboD7uh.js";
import { S as StatsCard } from "./StatsCard-CfYHEYSm.js";
import { c as createLucideIcon, g as clsx, C as Card, d as CardHeader, e as CardTitle, a as CardContent } from "./card-Cb1AW6bU.js";
import { I as INITIAL_ATTENDANCE, a as INITIAL_FEES, D as DEPARTMENTS, F as FACULTY, S as STUDENTS, C as COURSES } from "./college-data-C1ddpZzr.js";
...
function DashboardPage() {
  ...
  const todayAttendance = INITIAL_ATTENDANCE.filter((a2) => a2.date === today);
  const presentToday = todayAttendance.filter((a2) => a2.status === "present").length;
  const totalToday = todayAttendance.length;
  const attendanceRate = totalToday > 0 ? Math.round(presentToday / totalToday * 100) : 0;
  const totalFees = INITIAL_FEES.reduce((s2, f) => s2 + f.amount, 0);
  const collectedFees = INITIAL_FEES.reduce((s2, f) => s2 + f.paid, 0);
  const pendingFees = totalFees - collectedFees;
  const deptData = DEPARTMENTS.map((d) => ({
    name: d.length > 8 ? d.slice(0, 8) + "…" : d,
    students: STUDENTS.filter((s2) => s2.department === d).length,
  ...
  const attendanceData = [{
    name: "Present",
    value: todayAttendance.filter((a2) => a2.status === "present").length
  }, {
    name: "Absent",
    value: todayAttendance.filter((a2) => a2.status === "absent").length
  }, {
    name: "Late",
    value: todayAttendance.filter((a2) => a2.status === "late").length
  }];
  const semesterData = [1, 2, 3, 4, 5, 6, 7, 8].map((sem) => ({
    semester: `Sem ${sem}`,
    students: STUDENTS.filter((s2) => s2.semester === sem).length
  }));
  const COLORS = ["hsl(145, 60%, 45%)", "hsl(0, 70%, 55%)", "hsl(45, 70%, 55%)"];
  const FEE_COLORS = ["hsl(145, 60%, 45%)", "hsl(0, 70%, 55%)"];
  const recentActivity = [{
    action: "Fee collected",
    detail: "Rahul Kumar — Tuition ₹50,000",
    time: "5 min ago",
    icon: IndianRupee
  }, {
    action: "Attendance marked",
    detail: "Data Structures — Sem 4 CS",
    time: "10 min ago",
    icon: ClipboardCheck
  }, {
    action: "New student enrolled",
    detail: "Kavita Nair — Civil Eng",
    time: "1 hour ago",
    icon: Users
  }, {
    action: "Exam scheduled",
    detail: "DBMS Mid-term — 15 April",
    time: "2 hours ago",
    icon: FileText
  }, {
    action: "Result published",
    detail: "Mathematics — Sem 2",
    time: "5 hours ago",
    icon: TrendingUp
  }];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(DashboardLayout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-muted-foreground", children: "Here's what's happening at your college today." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatsCard, { title: "Total Students", value: STUDENTS.length, subtitle: "Across all departments", icon: Users, trend: {
        value: "12% this semester",
        positive: true
      } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatsCard, { title: "Today's Attendance", value: `${attendanceRate}%`, subtitle: `${presentToday}/${totalToday} students`, icon: ClipboardCheck, colorClass: "bg-success" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatsCard, { title: "Fee Collected", value: `₹${(collectedFees / 1e3).toFixed(0)}K`, subtitle: `₹${(pendingFees / 1e3).toFixed(0)}K pending`, icon: IndianRupee, colorClass: "bg-info" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatsCard, { title: "Faculty Members", value: FACULTY.length, subtitle: `${COURSES.length} active courses`, icon: UserCog, colorClass: "bg-accent" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 grid grid-cols-1 gap-6 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-0 shadow-md", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg", children: "Department Overview" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 250, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: deptData, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "students", fill: "hsl(220, 70%, 50%)", name: "Students", radius: [4, 4, 0, 0] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "faculty", fill: "hsl(45, 70%, 55%)", name: "Faculty", radius: [4, 4, 0, 0] })
        ] }) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-0 shadow-md", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg", children: "Today's Attendance" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 250, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Pie, { data: attendanceData, cx: "50%", cy: "50%", innerRadius: 60, outerRadius: 90, paddingAngle: 5, dataKey: "value", label: ({
            name,
            value
          }) => `${name}: ${value}`, children: attendanceData.map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: COLORS[i] }, i)) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 grid grid-cols-1 gap-6 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-0 shadow-md", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg", children: "Fee Collection" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 250, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Pie, { data: feeData, cx: "50%", cy: "50%", outerRadius: 90, dataKey: "value", label: ({
            name,
            value
          }) => `${name}: ₹${(value / 1e3).toFixed(0)}K`, children: feeData.map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: FEE_COLORS[i] }, i)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { formatter: (v) => `₹${v.toLocaleString()}` })
        ] }) }) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-0 shadow-md", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg", children: "Students by Semester" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 250, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: semesterData, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "hsl(var(--border))" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "semester", tick: {
            fontSize: 11
          } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { tick: {
            fontSize: 11
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "students", fill: "hsl(260, 50%, 50%)", name: "Students", radius: [4, 4, 0, 0] })
        ] }) }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-0 shadow-md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg", children: "Recent Activity" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: recentActivity.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-secondary", children: /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { className: "h-4 w-4 text-primary" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: item.action }),
